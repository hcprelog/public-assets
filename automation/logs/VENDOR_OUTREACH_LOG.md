...
- COLD → Email not yet sent (draft exists in Gmail or phone-only contact)
- EMAIL SENT → Outreach delivered, monitoring for reply
- INTERESTED → Vendor replied positively — call them, move to Step 7 of SOP-001
- NOT_INTERESTED → Pass, update vendor file, note for future reference
- FOLLOW_UP_NEEDED → Vendor has questions — reply within 24 hours
- REVIEW_NEEDED → Reply received but classification unclear — check Gmail manually
...
## REPLY LOG (populated by automation)
